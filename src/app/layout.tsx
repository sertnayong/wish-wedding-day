...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${hurricane.variable} font-hurricane flex flex-col bg-gray-50
       ...
       dark:text-opacity-90 antialiased`}>
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-[10] flex-1 left-[-35rem] h-[31.25rem] w-[50rem] 
